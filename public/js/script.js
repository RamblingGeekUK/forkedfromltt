    ...
    if (filtered.length === 0) {
      ...
      filtered.forEach(channel => {
        ...
        if (channel.ad) {
          ...
          const defaultImage = 'images/default-creator.svg';
            ...
            if (channel.socials.youtube && Array.isArray(channel.socials.youtube)) {
              channel.socials.youtube.forEach(yt => {
                if (yt.visible && yt.url) {
                  socialIcons += `<a href="${yt.url}" target="_blank" title="YouTube" class="ms-1"><svg width="20" height="20" fill="#ff0000" viewBox="0 0 24 24"><path d="M23.498 6.186a2.994 2.994 0 0 0-2.112-2.12C19.228 3.5 12 3.5 12 3.5s-7.228 0-9.386.566A2.994 2.994 0 0 0 .502 6.186C0 8.344 0 12 0 12s0 3.656.502 5.814a2.994 2.994 0 0 0 2.112 2.12C4.772 20.5 12 20.5 12 20.5s7.228 0 9.386-.566a2.994 2.994 0 0 0 2.112-2.12C24 15.656 24 12 24 12s0-3.656-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg></a>`;
                }
              });
            }
            // Twitter
            ...
            if (channel.socials.instagram && Array.isArray(channel.socials.instagram)) {
              channel.socials.instagram.forEach(ig => {
                if (ig.visible && ig.url) {
                  socialIcons += `<a href="${ig.url}" target="_blank" title="Instagram" class="ms-1"><svg width="20" height="20" fill="#E4405F" viewBox="0 0 24 24"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z"/></svg></a>`;
                }
              });
            }
            // Website
            if (channel.socials.website && Array.isArray(channel.socials.website)) {
              channel.socials.website.forEach(web => {
                if (web.visible && web.url) {
                  socialIcons += `<a href="${web.url}" target="_blank" title="Website" class="ms-1"><svg width="20" height="20" fill="#b0b3b8" viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 17.93c-3.94-.49-7-3.85-7-7.93 0-.62.08-1.21.21-1.79L9 15v1c0 1.1.9 2 2 2v1.93zm6.9-2.54c-.26-.81-1-1.39-1.9-1.39h-1v-3c0-.55-.45-1-1-1H8v-2h2c.55 0 1-.45 1-1V7h2c1.1 0 2-.9 2-2v-.41c2.93 1.19 5 4.06 5 7.41 0 2.08-.8 3.97-2.1 5.39z"/></svg></a>`;
                }
              });
            }
            // Bluesky
            ...
            <div class="card h-100 shadow-lg border-0">
              ...
              <div class="card-body d-flex flex-column justify-content-between">
                ...
                ${hasVideoData ? 
                  ...
                  `<div class="mb-2">
                    <span style="font-size:0.95em; color:#aaa;">Content Creator</span>
                  </div>`
                }
                ...
                ${hasVideoData ? 
                  ...
                  `${channel.socials?.website?.[0]?.url ? 
                    `<a href="${channel.socials.website[0].url}" target="_blank" class="btn btn-outline-light w-100 mt-auto">Website</a>` : 
