// Fetch and display videos for creators who are still at LTT
fetch("/api/branching-out-videos")
  .then(res => {
    if (!res.ok) {
            ...
            <div class="card h-100 shadow-lg border-0">
              ...
              <div class="card-body d-flex flex-column justify-content-between">
                ...
                <div class="social-icons mb-2">
                  ...
                  ${video.socials && video.socials.soundcloud && video.socials.soundcloud.visible ? `<a href="${video.socials.soundcloud.url}" target="_blank" title="SoundCloud" class="ms-1"><svg width="20" height="20" fill="#ff5500" viewBox="0 0 24 24"><path d="M17.5 10.5c-.4 0-.8.1-1.1.2-.2-2.6-2.4-4.7-5-4.7-.5 0-1 .1-1.5.2-.2 0-.4.2-.4.5v8.3c0 .3.2.5.5.5h10c1.4 0 2.5-1.1 2.5-2.5s-1.1-2.5-2.5-2.5zm-11.5-.5c-.3 0-.5.2-.5.5v5c0 .3.2.5.5.5s.5-.2.5-.5v-5c0-.3-.2-.5-.5-.5zm2 1c-.3 0-.5.2-.5.5v4c0 .3.2.5.5.5s.5-.2.5-.5v-4c0-.3-.2-.5-.5-.5zm2 1c-.3 0-.5.2-.5.5v3c0 .3.2.5.5.5s.5-.2.5-.5v-3c0-.3-.2-.5-.5-.5zm2 1c-.3 0-.5.2-.5.5v2c0 .3.2.5.5.5s.5-.2.5-.5v-2c0-.3-.2-.5-.5-.5z"/></svg></a>` : ''}
                </div>
